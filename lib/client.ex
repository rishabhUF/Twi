defmodule Client do
    ...
    def handle_cast({:send_retweet,tweet_text}, %User{username: username, followers: followers, homepage: homepage, tweets: tweets_}= user) do
    ...
    def handle_cast({:add_tweet,tweet},%User{tweets: tweets, followers: followers, online: online}=user) do
        ...
        if(String.contains?tweet,"@") do
            ...
            Enum.each(mentions_, fn(x) ->
               GenServer.cast(Mainserver,{:add_mentions,x,tweet}) 
           end)
